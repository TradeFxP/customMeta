      ...
      <div className="container privacy-body">
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            <strong>https://metagensoft.com/</strong> ('Website'), including the related mobile site and
            mobile application (hereinafter referred to as 'Platform').
          </p>
          <p>
            The Platform is owned by <strong>Metagen Technologies</strong>, a company incorporated under
            the Companies Act, 1956 with its registered office at{' '}
            <strong>
              Lotus Heights, Kavuri Hills Phase 2 Rd, beside D-Mart, Kavuri Hills, Madhapur, Hyderabad,
              Telangana 500033
            </strong>{' '}
          ...
          <p>
            ...
            are incorporated herein by way of reference. If You transact on the Platform, You shall be
        ...
        <section className="privacy-section">
          ...
          <ol>
            <li>
              ...
              us during and after registration, and you shall be responsible for all acts done through the use
              of your registered account on the Platform.
            </li>
            <li>
            ...
            <li>
              ...
              for which we shall not be liable to you in any manner. You are required to independently assess
            ...
            <li>
              ...
              any failure to perform an obligation under these Terms if performance is prevented or delayed by
